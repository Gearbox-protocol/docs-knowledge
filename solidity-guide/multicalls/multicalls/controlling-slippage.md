...
> For SDK implementation, see [Controlling Slippage](../../../sdk-guide-typescript/multicalls/multicalls/controlling-slippage.md).
...
* [The Diff Pattern](../#the-diff-pattern) - Handling unknown amounts
