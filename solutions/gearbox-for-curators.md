...
## Multichain UI support for leverage & borrows

some other prtocools require Curators to source integrations with other UI when deploying on new chains. Gearbox, on the other hand, supports UX for both lending and borrowing side out of the box. Easier path to users!
