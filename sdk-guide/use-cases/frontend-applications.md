...
- Call compressors directly (see [Real-Time Updates](#real-time-updates))
...
|-------------|-----------------|
| Deposit collateral | [Adding Collateral](../multicalls/adding-collateral.md) |
| Borrow more | [Debt Management](../multicalls/debt-management.md) |
| Repay debt | [Debt Management](../multicalls/debt-management.md) |
| Update quota | [Updating Quotas](../multicalls/updating-quotas.md) |
| Withdraw | [Withdrawing Collateral](../multicalls/withdrawing-collateral.md) |
| Swap collateral | [Making External Calls](../multicalls/making-external-calls.md) |
...
- [Multicall Operations](../multicalls/README.md) - Implement position management
- [Backend Services](./backend-services.md) - If you also need historical data
- [Compressors Reference](../../reference/compressors.md) - Complete compressor API
