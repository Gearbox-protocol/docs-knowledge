...
A Credit Account is user-owned smart-contract wallet, not a slice of a shared vault. Add assets to unlock a credit line and use that account to trade, farm, or restake across integrated protocols while keeping ownership and portability. The protocol checks solvency on every move so risk stays controlled.
