...
$$
Total Value = \frac{\sum_{i}^{MaxEnabledTokens}{CollateralBalance_i \times CollateralOraclePrice_i}}{UnderlyingOraclePrice}
$$
...
$$
TWV = \frac{\sum_{i}^{MaxEnabledTokens}{\min{(Quota_i,LT_i \times CollateralBalance_i \times CollateralOraclePrice_i)}}}{UnderlyingOraclePrice}
$$
