...
4. [**Multicalls**](multicalls/) - Building and executing multicalls
...
The SDK handles ABI management, type conversions, and caching internally. For on-chain integrations or gas-optimized bot implementations, consider the [Solidity Guide](../solidity-guide/solidity-guide.md).
...
| [Making External Calls](multicalls/multicalls/making-external-calls.md)         | Interact with DeFi protocols      |
| [Enabling/Disabling Tokens](multicalls/multicalls/enabling-disabling-tokens.md) | Manage active collateral          |
| [Updating Price Feeds](multicalls/multicalls/updating-price-feeds.md)           | On-demand oracle updates          |
| [Collateral Check Params](multicalls/multicalls/collateral-check-params.md)     | Optimize health checks            |
| [Revoke Allowances](multicalls/multicalls/revoke-allowances.md)                 | Security cleanup                  |

See [Multicalls Overview](multicalls/) for building and executing multicalls.
